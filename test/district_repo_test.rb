...
class DistrictRepoTest < Minitest::Test
  ...
  #   dr = DistrictRepository.new
  #   dr.load_csv([{:name => "ACADEMY 20", :kindergarten_participation => {2010 => 0.3915, 2011 => 0.35356, 2012 => 0.2677}}])
  ...
  #   dr = DistrictRepository.new
  #   dr.load_csv([{:name => "ACAD"}, {:name => "turing"}, {:name => "ACADEMY 20", :kindergarten_participation => {2010 => 0.3915, 2011 => 0.35356, 2012 => 0.2677}}])
