...
class EconomicProfileTest < Minitest::Test
  ...
  def test_estimated_median_income_in_year_returns_integer_for_2010
    ep = EconomicProfileRepository.new
    ep.load_data(input)
    assert_equal 46163.6, ep.economic_profiles[0].estimated_median_household_income_in_year(2010)
  end 
  ...
  def test_unknown_year_returns_unknown_data_error
    ...
    assert_raises "UnknownDataError" do
      ep.ep.economic_profiles[0].estimated_median_household_income_in_year(3000)
    end
  end 
  ...
  #   ep = EconomicProfileRepository.new
  #   ep.load_data(input)
  #   assert (ep.economic_profiles[0].children_in_poverty_in_year(2012) <= 1)
  # end 
